# deepseek web页面形式client
# -*- coding: utf-8 -*-
import requests
from ..config.deepseek_config import Config
from deepseek.tools.http_response_tool import ds_http_extract_content, ds_web_agent_extract_content


class DeepseekWebHttpClient:
